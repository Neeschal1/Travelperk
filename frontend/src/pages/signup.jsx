...
import signupbanner from "../assets/images/signup.jpg";
  ...
  return (
    ...
    >
      <div className="bg-white/30 backdrop-blur-sm flex w-full h-full justify-center items-center">
        <div className="bg-white flex flex-row items-center rounded-3xl w-8/12">
          <div className="flex flex-col w-full items-center">
            ...
            <div className="flex flex-col">
              ...
              <h2>Welcome to travelperk. Fill up the following details in order to continue :)</h2>
            </div>
            ...
            <button onClick={handleSignup} className="bg-blue-400 hover:bg-blue-600 hover:cursor-pointer text-white py-3 rounded-full font-regular duration-400">
              Signup
            </button>
          </div>
          <h1>Already have an account? <a href="http://localhost:5173/login">Login</a></h1>
          </div>
          <img
            className="h-215 w-full relative rounded-br-3xl rounded-tr-3xl"
            src={signupbanner}
          />
        </div>
      </div>
